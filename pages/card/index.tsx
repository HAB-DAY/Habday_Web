    ...
    >
      ...
      <Styled.Form>
        ...
        <Styled.InputContainer>
          ...
          <Styled.Input placeholder="YYYY - MM" onChange={(e) => setNewPayForm({ expiry: e.target.value })} />
        </Styled.InputContainer>
        <Styled.InputContainer>
          <Styled.Label>생년월일</Styled.Label>
          <Styled.Input placeholder="6자리" onChange={(e) => setNewPayForm({ birth: e.target.value })} />
        </Styled.InputContainer>
        <Styled.InputContainer>
          <Styled.Label>비밀번호</Styled.Label>
          <Styled.Input placeholder="앞 2자리" onChange={(e) => setNewPayForm({ pwd_2digit: e.target.value })} />
        </Styled.InputContainer>
        <Styled.InputContainer>
          <Styled.Label>카드별칭</Styled.Label>
          <Styled.Input placeholder="최대 6자리" onChange={(e) => setNewPayForm({ payment_name: e.target.value })} />
        </Styled.InputContainer>
